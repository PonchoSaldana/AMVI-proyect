      ...
      <div className="max-w-7xl mx-auto flex flex-col items-center gap-6">
        ...
        <div className="max-w-3xl text-center space-y-4">
          <p className="text-[10px] sm:text-xs text-slate-500 dark:text-slate-400 leading-relaxed font-medium">
            AMVI es una asistente basada en inteligencia artificial diseñada para proporcionar apoyo informativo y herramientas de seguimiento de salud. 
          ...
          <p className="text-[10px] text-slate-400 dark:text-slate-500 leading-relaxed">
            La precisión de la información generada por AMVI puede variar y no está garantizada. En caso de una emergencia médica o síntomas graves, 
        ...
        <div className="pt-6 flex flex-col items-center gap-2 text-center">
          <p className="text-[9px] font-bold text-slate-300 dark:text-white/20 uppercase tracking-[0.4em] text-center">
            © 2026 AMVI - Asistente Médico Virtual Inteligente.
          </p>
